    ...
    <section>
      ...
      <form className="support">
        ...
        <div className="support-chat">
          <div className="chat">
            <UserMessage
              time={"12:37"}
              text={
                "Здравствуйте! Все приехало остывшее, заказ добирался до меня 3 часа! Карл, 3 часа! Вы бы хоть предупредили, что задерживаетесь."
              }
            />
            <ManagerMessage
              time={"12:37"}
        ...
        <div className="support-form">
          ...
          <button type="submit" className="btn-secondary py-2 mx-3">
            Отправить
          </button>
