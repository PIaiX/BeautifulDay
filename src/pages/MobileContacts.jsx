...
import MobilePromo from '../assets/imgs/bg/mobilePromo.jpg';
    ...
    <main>
        <section className='mobileOnly'>
            <figure className='mobileOnly-img'>
                ...
                <figcaption>
                    <Link to="/menu" className='btn-aqua fs-09 mx-auto'>В каталог</Link>
                </figcaption>
            </figure>
            ...
            <Container>
                <ul>
                    ...
                    <li>
                        <a href="https://vk.com/bdkzn" target="_blank">Вконтакте</a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/presents_beautifulday/" target="_blank">Нельзяграм</a>
                    </li>
                    <li>
