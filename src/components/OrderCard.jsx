  ...
  return (
    <div className="order-card">
      <div className="order-card-num">
        <Link to="3471" className="d-lg-none secondary fs-11 fw-6">
          Заказ №3471
        </Link>
      ...
      <div className="order-card-status">
        <div className="bg-success success rounded-3 px-1">Готовится</div>
      </div>
      <div className="order-card-delivery">
        Самовывоз <span className="dark-gray ms-1">•</span>
      </div>
          ...
          >
            <SwiperSlide>
              <Link to="/menu/product">
                <img src="/images/img3.png" alt="Название" />
              </Link>
            </SwiperSlide>
            <SwiperSlide>
              <Link to="/menu/product">
      ...
      <div className="order-card-btn">
        ...
        <button type="button" className="btn-light d-lg-none w-100 rounded-3">
          Повторить заказ
        </button>
      </div>
    </div>
